...
import com.che2n3jigw.naviplayer.feature.player.api.widget.PlayerDeepLink
import com.che2n3jigw.naviplayer.feature.player.api.widget.PlayerNavigator
import javax.inject.Inject

class PlayerNavigatorImpl @Inject constructor() : PlayerNavigator {

    override fun navigateToPlayer(navController: NavController) {
        val request = NavDeepLinkRequest.Builder
            .fromUri(PlayerDeepLink.PLAYER.toUri())
            .build()
