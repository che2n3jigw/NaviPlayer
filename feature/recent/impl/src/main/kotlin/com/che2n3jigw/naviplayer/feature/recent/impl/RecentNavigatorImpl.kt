...
import com.che2n3jigw.naviplayer.feature.rencet.api.RecentDeepLink
import com.che2n3jigw.naviplayer.feature.rencet.api.RecentNavigator
import javax.inject.Inject

class RecentNavigatorImpl @Inject constructor() : RecentNavigator {
    override fun navigateToRecent(navController: NavController) {
        val request = NavDeepLinkRequest.Builder
            .fromUri(RecentDeepLink.RECENT.toUri())
            .build()
